...
require('lazy').setup({
  ...
  'neovim/nvim-lspconfig', -- Quick setup for LSP servers
  'L3MON4D3/LuaSnip', -- Snippet engine for better coding workflow
  'kyazdani42/nvim-tree.lua', -- File explorer for Neovim
  'akinsho/bufferline.nvim', -- Better buffer line for easier navigation
  'hoob3rt/lualine.nvim', -- Enhanced status line
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'gdscript', 'cpp', 'python', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
